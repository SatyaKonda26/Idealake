...
export const  servicesData = [
  ...
  {
    id: 2,
    icon: "icon-enterprise-application",
  ...
  {
    id: 6,
    icon: "icon-artificial-intelligence",
    title: "AI And ML",
    details:
  ...
  {
    id: 9,
    icon: "icon-onsite-professionals",
          ...
          {servicesData &&
            servicesData.map((data, i) => (
              <li key={i} className={`flex ${style.card}`}>
                <Link
                  href={`service/service-detail/${data.id}`}
                  title={data.title}
                >
                  <span className={`${data.icon} ${style.logo}`} />
